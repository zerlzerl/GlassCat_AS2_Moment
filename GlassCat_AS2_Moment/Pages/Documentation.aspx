...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="jumbotron">
        ...
        <strong>Homepage:</strong><p>
            After a successful login, the blue-and-white card will no longer show the logo and slogan of our website, but the user's personal information. To the right of the card, 
            there's a list of moments post by all the members from our community. You can post one as well! At the bottom of this page, there come the advertisements which may be beneficial for your cats.
        </p>
